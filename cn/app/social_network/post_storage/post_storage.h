...
void init_specific_config(){
    ...
    auto write_to = config_json_all["post_storage"]["write_to_mongodb"];
    rmem::rt_assert(!write_to.is_null(),"value is null");
    write_to_mongodb = write_to;
