...
user = "cxz"
passwd = "cxz123"
output_file_format = "/home/cxz/fork_test_rmem_result/{}_b{}_t{}_cow{}"
...
extra_server = "--block_size={0} --rmem_self_index={1} --rmem_server_index={2}"
    ...
    for b_i in msg_size:
        ...
        for t_i in num_threads:
            for z_i in zero_copys:
                ...
                t1.join()
                m1.join()
                print("finish: thread {} cow {} block_size {}\n".format(t_i, z_i, b_i))
