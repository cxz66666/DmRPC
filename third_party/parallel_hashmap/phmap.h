...
namespace phmap
{
    ...
    namespace priv
    {
        ...
        struct IsDecomposable<
            phmap::void_t<decltype(Policy::apply(RequireUsableKey<typename Policy::key_type, Hash, Eq>(),
                                                 std::declval<Ts>()...))>,
...
#pragma warning(pop)
        ...
        public:
            ...
            explicit parallel_hash_set(size_t bucket_cnt,
                                       ...
                                       const key_equal &eq = key_equal(),
                                       const allocator_type &alloc = allocator_type()) : parallel_hash_set(typename Inner::Params{bucket_cnt, hash_param, eq, alloc},
